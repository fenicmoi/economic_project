                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                    <?php   
                                        $sql = "SELECT * FROM project WHERE gid=1";
                                        $result = dbQuery($sql);
                                        $no = 1;
                                        while ($row = dbFetchArray($result)) {?>
                                           <tr>
                                                ...
                                                <td><a href="showDetail.php?id=<?php echo $row['id'];?>"><?php echo $row['pname']?></a></td>
                                                <td><?php echo number_format($row['money'])?></td>
                                                <td><?php echo $row['rec_money']?></td>
                                                <td><?php echo $row['operation']?></td>
                                                 <td>
                                                     <a href="editDetail.php?id=<?php echo $row['id']?>" class="btn btn-warning btn-sm">Edit</a>
                                                </td> 
                                                <td>
                                                <?php  
                                                    if($row['doc']==''){?>
                                                       ไม่มีข้อมูล
                                                   <?php }else{?>
                                                        <a href="doc/<?php echo $row['doc']?>" class="btn btn-success btn-sm" target="_blank">เอกสาร</a>
                                                   <?php }
                                                ?>
                      ...
                      <!-- Modal Show -->
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">รายละเอียดโครงการ</h5>
