                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                    <?php   
                                        $sql = "SELECT * FROM project WHERE gid=2";
                                        $result = dbQuery($sql);
                                        $no = 1;
                                        while ($row = dbFetchArray($result)) {?>
                                           <tr>
                                                ...
                                                <td><?php echo $row['operation']?></td>
                                                 <td>
                                                     <a href="upload.php?pid=<?php echo $row['pid']?>" class="btn btn-warning btn-sm">Upload</a>
                                                </td> 
                                                <td>
                                                <?php  
                                                    if($row['doc']==''){?>
                                                       ไม่มีข้อมูล
                                                   <?php }else{?>
                                                        <a href="doc/<?php echo $row['doc']?>" class="btn btn-success btn-sm" target="_blank">Download</a>
                                                   <?php }
                                                ?>
