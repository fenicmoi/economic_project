...
$db_config=array(
        ...
        "dbname"=>"project-root",  // กำหนดชื่อฐานข้อมูล
        "charset"=>"utf8"  // กำหนด charset
    );
...
/*
    ...
    $db_config=array(
        "host"=>"localhost",  // กำหนด host
        "user"=>"phatthalun_ptl", // กำหนดชื่อ user
        "pass"=>"nSSYV5cJ",   // กำหนดรหัสผ่าน
        "dbname"=>"phatthalun_wfh",  // กำหนดชื่อฐานข้อมูล
        "charset"=>"utf8"  // กำหนด charset
    );
*/
/*
$db_config=array(
    ...
    "user"=>"phatthalun_dol", // กำหนดชื่อ user
    "pass"=>"nSSYV5cJ",   // กำหนดรหัสผ่าน
    "dbname"=>"phatthalun_root",  // กำหนดชื่อฐานข้อมูล
    "charset"=>"utf8"  // กำหนด charset
);
*/
